...
induction H.
- simpl in E. apply E.
- simpl in E. inversion E. apply IHev in H1. apply H1.
 Qed.
...
Proof.
  ...
  { intros H. rewrite (add_comm n p). 
    rewrite (add_comm m p). rewrite plus_swap.
    rewrite add_assoc. rewrite add_assoc.
    rewrite <- double_plus.
    rewrite <- (add_assoc (double p) n m).
...
Proof.
intros p b. intros H. destruct H.
- split.
  + intros H1. reflexivity.
  + intros H1. apply H.
- split.
  + intros H1. apply H in H1. contradiction.
